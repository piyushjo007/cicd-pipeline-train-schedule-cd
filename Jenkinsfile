                            ...
                            sshPublisherDesc(
                                ...
                                transfers: [
                                    sshTransfer(
                                        ...
                                        removePrefix: 'dist/',
                                        remoteDirectory: '/tmp',
                                        execCommand: 'sudo mkdir /home/trnap/test/ && sudo unzip /tmp/trainSchedule.zip -d /home/trnap/test/ && /home/trnap/test/gradle wrapper && sh /home/trnap/test/gradlew npm_start'
                                    )
                                ]
                            )
                        ]
